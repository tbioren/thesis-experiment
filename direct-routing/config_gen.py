...
LOCAL_NET_CONFIG = {
    ...
    'local_g0_1': {
        'bit_positions': ['B0[15]', 'B0[16]', 'B0[17]', 'B0[18]', 'B1[18]'],
        'neighbors': {
            'bot': [1, 0, 1, 0, 0],  # neigh_op_bot_1
            'top': [1, 0, 1, 0, 1],  # neigh_op_top_1
            'lft': [1, 0, 1, 1, 0],  # neigh_op_lft_1
            'bnr': [0, 0, 1, 1, 1],  # neigh_op_bnr_1
        }
    },
    'local_g2_1': {
        'bit_positions': ['B8[15]', 'B8[16]', 'B8[17]', 'B8[18]', 'B9[18]'],
        'neighbors': {
            'rgt': [1, 0, 1, 1, 0],  # neigh_op_rgt_1
            'bnl': [0, 0, 1, 1, 1],  # neigh_op_bnl_1
            'tnl': [1, 0, 1, 0, 1],  # neigh_op_tnl_1
            'tnr': [1, 0, 1, 0, 0],  # neigh_op_tnr_1
        }
    },
    
    # Input 2 recommended nets
    'local_g0_2': {
        'bit_positions': ['B0[25]', 'B1[22]', 'B1[23]', 'B1[24]', 'B1[25]'],
        'neighbors': {
            'bot': [0, 1, 0, 1, 0],  # neigh_op_bot_2
            'top': [0, 1, 0, 1, 1],  # neigh_op_top_2
            'lft': [1, 1, 0, 1, 0],  # neigh_op_lft_2
            'bnr': [1, 1, 0, 0, 1],  # neigh_op_bnr_2
        }
    },
    'local_g2_2': {
        'bit_positions': ['B8[25]', 'B9[22]', 'B9[23]', 'B9[24]', 'B9[25]'],
        'neighbors': {
            'rgt': [1, 1, 0, 1, 0],  # neigh_op_rgt_2
            'bnl': [1, 1, 0, 0, 1],  # neigh_op_bnl_2
            'tnl': [0, 1, 0, 1, 1],  # neigh_op_tnl_2
            'tnr': [0, 1, 0, 1, 0],  # neigh_op_tnr_2
        }
    },
    
    # Input 3 recommended nets
    'local_g0_3': {
        'bit_positions': ['B0[21]', 'B0[22]', 'B0[23]', 'B0[24]', 'B1[21]'],
        'neighbors': {
            'bot': [0, 1, 0, 1, 0],  # neigh_op_bot_3
            'top': [0, 1, 0, 1, 1],  # neigh_op_top_3
            'lft': [1, 1, 0, 1, 0],  # neigh_op_lft_3
            'bnr': [1, 1, 0, 0, 1],  # neigh_op_bnr_3
        }
    },
    'local_g2_3': {
        'bit_positions': ['B8[21]', 'B8[22]', 'B8[23]', 'B8[24]', 'B9[21]'],
        'neighbors': {
            'rgt': [1, 1, 0, 1, 0],  # neigh_op_rgt_3
            'bnl': [1, 1, 0, 0, 1],  # neigh_op_bnl_3
            'tnl': [0, 1, 0, 1, 1],  # neigh_op_tnl_3
            'tnr': [0, 1, 0, 1, 0],  # neigh_op_tnr_3
        }
    },
}
...
RECOMMENDED_NETS = {
    0: ['local_g0_0', 'local_g2_0'],
    1: ['local_g0_1', 'local_g2_1'],
    2: ['local_g0_2', 'local_g2_2'],
    3: ['local_g0_3', 'local_g2_3'],
}
